  ...
  return (
    <div className="min-h-screen pb-24 bg-white dark:bg-zinc-950">
      <div className="max-w-screen-sm mx-auto md:max-w-3xl p-4">
        {/* Header */}
        <div className="py-6">
          <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Bingo</h1>
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Bingo Feature</h3>
