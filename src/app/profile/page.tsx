    ...
    <div className="min-h-screen pb-24 bg-white dark:bg-zinc-950">
      <div className="max-w-screen-sm mx-auto md:max-w-3xl p-4">
        ...
        <div className="py-6">
          ...
          <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Manage your account</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Profile Feature</h3>
